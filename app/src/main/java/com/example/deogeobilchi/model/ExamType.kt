...
private fun getTypeDetail(type: EnumExamType) {
    when (type) {
        ...
        EnumExamType.S -> ExamType().S
        EnumExamType.E -> ExamType().E
        EnumExamType.C -> ExamType().C
    }
}

class ExamType {
    var R = ExamTypeDetail(
